    ...
    >
      ...
      <div className="lg:hidden flex flex-col justify-center items-center w-full relative z-10 px-4 py-8">
        ...
        <div className="w-full max-w-sm">
          {!isVerificationStep ? (
            <form onSubmit={handleSubmit} className={`p-6 w-full ${isDarkMode ? 'bg-gray-900/90 backdrop-blur-sm border border-gray-700 text-white' : 'bg-white/90 backdrop-blur-sm border border-gray-200 text-gray-900'} rounded-2xl shadow-lg`}>
              ...
              <div className="text-center mt-4">
                <p className={`${isDarkMode ? 'text-gray-400' : 'text-gray-600'} text-sm`}>Already have an account?</p>
                <button 
                  type="button" 
            ...
            <form onSubmit={handleVerify} className={`p-6 w-full ${isDarkMode ? 'bg-gray-900/90 backdrop-blur-sm border border-gray-700 text-white' : 'bg-white/90 backdrop-blur-sm border border-gray-200 text-gray-900'} rounded-2xl shadow-lg`}>
              ...
              <input
                ...
                value={verificationCode}
                onChange={(e) => setVerificationCode(e.target.value)}
                className={`w-full p-3 rounded border mt-2 mb-4 text-sm ${
                  isDarkMode 
                    ? 'text-white border-gray-700 focus:border-[#1e90ff] bg-gray-900/50' 
                    : 'text-gray-900 border-gray-400 focus:border-[#1e90ff] bg-white'
                } transition-all duration-200`}
              ...
              <button 
                type="submit" 
                disabled={isVerifying}
                className={`w-full p-3 rounded-lg transition text-sm ${
                  isDarkMode ? 'bg-[#1e90ff] hover:bg-[#5141e1]' : 'bg-[#1e90ff] hover:bg-[#5141e1]'
                } text-white`}
              >
                {isVerifying ? 'Verifying...' : 'Verify Email'}
